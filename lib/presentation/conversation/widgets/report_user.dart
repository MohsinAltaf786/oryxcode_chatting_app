  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        children: [
          spacing(height: 20),
          Icon(TablerIcons.thumb_down, color: Colors.red.shade600, size: 80),
          spacing(height: 20),
          Text(trans(context, key: 'report_user'),
              style: StyleHelper.headlineSmall(context)
                  ?.copyWith(fontWeight: FontWeight.w500)),
          spacing(height: 5),
          Text(trans(context, key: 'are_you_sure_you_want_to_report_this_user'),
