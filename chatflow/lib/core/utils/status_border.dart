...
class DottedBorder extends CustomPainter {
  ...
  // Number of watched stories
  final int watchedStories;
  ...
  DottedBorder(
      ...
      this.spaceLength = 10})
      : assert(watchedStories <= numberOfStories);
    ...
    for (int i = 0; i < numberOfStories; i++) {
      ...
      canvas.drawArc(
          ...
          Paint()
            ...
            ..color = i < watchedStories
                ? Colors.grey.withValues(alpha: 0.5) // Watched stories color
                : AppColors.primary // Unwatched stories color
            ..strokeWidth = 2.3
